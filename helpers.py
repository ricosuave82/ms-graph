...
def permissions_check(session, drive_id, item_id):
    # endpoint = f'/sites/876198ab-8e19-48ee-a0e9-65abbb8ab29b/drive/items/869c4278-6699-4027-ba9f-be4ffe972d61/permissions'
...
def get_permission(session, drive_id, item_id, permission_id):
    # endpoint = f'/sites/876198ab-8e19-48ee-a0e9-65abbb8ab29b/drive/items/869c4278-6699-4027-ba9f-be4ffe972d61/permissions'
...
def list_group_members(session):
    endpoint = f'/groups/de753f1a-9b0d-47d4-8547-2cefa8f82225/members'
...
def get_user(session):
    ...
    endpoint = f'/users/b400f455-0ae3-4623-9e55-c58be331cedb'
